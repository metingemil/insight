...
/*
 * Avem un rand de sticle de vin cu preturi diferite in orice ordine.
 * Putem vinde sticle de vin ori din fata(stanga) ori din spate(dreapta) randului de sticle.
 * Dupa fiecare sticla vanduta, pretul tuturor sticlelor ramase creste cu 10%.
 * 
 * In ce ordine trebuiesc vandute sticlele astfel ca la sfarsit sa avem profitul maxim posibil.
 */
